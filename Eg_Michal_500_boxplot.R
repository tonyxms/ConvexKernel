...
### Michalewicz example for 6 active dimensions, input dimension p=10, n_train=500
B=20
...
#ggsave('Michal_10dim_500_20.pdf')
...
#write.csv(dim_10,file='Michal_10dim_500_20.csv')
save.image('result/Michal_10dim_500_20.RData')

rm(list=ls())

source('header.R')

### Michalewicz example for 6 active dimensions, input dimension p=20, n_train=500
B=20
RMSPE_sd <- data.frame(laGP=numeric(B),Opt_kernel=numeric(B),mlegp=numeric(B),MRFA=numeric(B))
theta=seq(from=1,to=9,length=5)
theta=c(theta*10^-2,theta*10^-1,theta,theta*10,theta*10^2)
...
#ggsave('Michal_20dim_500_20.pdf')
...
#write.csv(dim_10,file='Michal_20dim_500_20.csv')
save.image('result/Michal_20dim_500_20.RData')

rm(list=ls())

source('header.R')

### Michalewicz example for 6 active dimensions, input dimension p=60, n_train=500
B=20
RMSPE_sd <- data.frame(laGP=numeric(B),Opt_kernel=numeric(B),mlegp=numeric(B),MRFA=numeric(B))
theta=seq(from=1,to=9,length=5)
theta=c(theta*10^-2,theta*10^-1,theta,theta*10,theta*10^2)
...
#ggsave('Michal_60dim_500_20.pdf')
...
#write.csv(dim_10,file='Michal_60dim_500_20.csv')
save.image('result/Michal_60dim_500_20.RData')
