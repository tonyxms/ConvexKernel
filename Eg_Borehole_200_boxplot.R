...
### Borehole example for input dimension p=20, n_train=200, n_test=1000
B=50
...
#ggsave('Borehole_20dim_200_50.pdf')
...
#write.csv(dim_10,file='Borehole_20dim_200_50.csv')
save.image('result/Borehole_20dim_200_50.RData')

rm(list=ls())

source('header.R')

### Borehole example for input dimension p=60, n_train=200, n_test=1000
B=50
RMSPE_sd <- data.frame(laGP=numeric(B),Opt_kernel=numeric(B),mlegp=numeric(B),MRFA=numeric(B))
theta=seq(from=1,to=9,length=5)
theta=c(theta*10^-2,theta*10^-1,theta,theta*10,theta*10^2)
...
#ggsave('Borehole_60dim_200_50.pdf')
...
#write.csv(dim_10,file='Borehole_60dim_200_50.csv')
save.image('result/Borehole_60dim_200_50.RData')
